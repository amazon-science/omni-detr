...
def main():
    ...
    output_file_label = './../coco/annotations/instances_valminusminival2014_w_indicator.json'
    ...
    data['info'] = coco_api.dataset['info']
    data['licenses'] = coco_api.dataset['licenses']
    output_file_label = './../coco/annotations/instances_train2014_w_indicator_tagsU.json'
    ## save to json
    with open(output_file_label, 'w') as f:
        print('writing to json output:', output_file_label)
        # json.dump(sample_data, f, indent=4, sort_keys=True)
    ...
    data['info'] = coco_api.dataset['info']
    data['licenses'] = coco_api.dataset['licenses']
    output_file_label = './../coco/annotations/instances_train2014_w_indicator_pointsK.json'
    ## save to json
    with open(output_file_label, 'w') as f:
        print('writing to json output:', output_file_label)
        # json.dump(sample_data, f, indent=4, sort_keys=True)
